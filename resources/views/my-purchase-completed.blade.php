        ...
        <div class="content">
            <div class="card-info">
                <h3 class="fs-18 mb-2 d-flex">
                    Address
                    <label class="purchase-status completed ms-auto"
                        >Completed</label
                    >
                </h3>
            ...
            <div class="card-info">
                ...
                <div class="d-flex fs-15 py-2 pe-sm-4">
                    ...
                    <img
                        class="ms-auto"
                        style="height: 24px"
                        src="img/icons/icon-creditcard.png"
                        alt=""
                    />
                </div>
            </div>
        ...
        <div class="sidebar">
            ...
            <div class="card-info text-center py-4">
                <div class="buttons p-0 flex-column">
                    <a
                        class="btn btn-outline-yellow btn-34"
                        href="product-detail.html"
                        >Review</a
                    >
                </div>

                <p class="fs-12 fw-300 mt-3 mb-0" style="color: #faad17">
...
<script>
    var myModal = new bootstrap.Modal(
        document.getElementById("successPaymentModal")
    );
    myModal.show();
</script>
@endsection
