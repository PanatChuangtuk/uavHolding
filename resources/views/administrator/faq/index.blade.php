            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.faq') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.faq.add') }}"
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            ...
                            <tbody class="table-border-bottom-0" id="faqTableBody">
                                @foreach ($faq as $item)
                                    <tr>
                                        <td>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ Str::limit(strip_tags($item->content->content ?? 'No content'), 30, '...') }}
                                        </td>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0"
                                                        href="{{ route('administrator.faq.edit', ['id' => $item->id]) }}"
                                                    ...
                                                    <form id="deleteForm{{ $item->id }}"
                                                        action="{{ route('administrator.faq.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
