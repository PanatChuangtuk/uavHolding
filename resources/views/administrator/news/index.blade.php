            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.news') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.news.add') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->images->first())
                                                <img src="{{ asset('upload/file/news/' . $item->images->first()->image) }}"
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <div class="d-inline-block text-nowrap">
                                                            <a class="btn btn-icon btn-outline-primary border-0"
                                                                href="{{ route('administrator.news.edit', ['id' => $item->id]) }}"
                                                            ...
                                                            <form id="deleteForm{{ $item->id }}"
                                                                action="{{ route('administrator.news.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
                                                            ...
                                                            <form id="notificationForm{{ $item->id }}"
                                                                action="{{ route('administrator.news.notifications.show', ['id' => $item->id]) }}"
                                                                method="POST" style="display:inline;">
                                                                @csrf
                                                                <button type="button"
