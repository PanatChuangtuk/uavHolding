            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.brand-product') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.brand-product.add') }}"
                                ...
                                @foreach ($productBrands as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            @if ($item->image)
                                                <img src="{{ asset('upload/file/product_brand/' . $item->image) }}"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0"
                                                        href="{{ route('administrator.brand-product.edit', ['id' => $item->id]) }}"
                                                    ...
                                                    <form id="deleteForm{{ $item->id }}"
                                                        action="{{ route('administrator.brand-product.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
