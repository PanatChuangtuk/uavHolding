...
@section('content')
    <x-bread-crumb />
    <form id="form-create" action="{{ route('administrator.promo_discount.submit') }}" method="POST"
                ...
                <div class="col-md-10">
                    <select name="discount_type" id="productDiscountSelect" class="form-control">
                        ...
                        @foreach ($discountTypes as $type)
                            <option class="product-option" value="{{ $type }}" data-model="{{ $type }}"
            ...
            $('#addProductBtn').click(function() {
                ...
                if (selectedOption && selectedOption.length > 0) {
                    selectedOption.forEach(function(productId) {
                        var productText = $('#productSelect option[value="' + productId + '"]')
                            .text();
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        updateHiddenInput();
                        Swal.fire('Removed!', `${productText} has been removed.`, 'success');
                    }
                });
            });
                ...
                if (selectedProductIds.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            updateHiddenInput();
                            Swal.fire('Deleted!', 'Selected products have been removed.',
                                'success');
