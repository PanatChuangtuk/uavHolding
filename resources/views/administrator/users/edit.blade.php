                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="preview-container"
                            ...
                            <img id="imagePreview"
                                src="{{ $user->profile_image ? asset('upload/' . $user->profile_image) : '#' }}"
    ...
    <script>
        function previewImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                preview.src = "{{ $user->profile_image ? asset('upload/' . $user->profile_image) : '#' }}";
                container.style.display = "{{ $user->profile_image ? 'block' : 'none' }}";
            }
        }
    </script>
@endsection
