            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.social') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.social.add') }}"
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            ...
                            <tbody class="table-border-bottom-0" id="socialTableBody">
                                @foreach ($social as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->image)
                                                <img src="{{ asset('upload/file/social/' . $item->image) }}"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0"
                                                        href="{{ route('administrator.social.edit', ['id' => $item->id]) }}"
                                                    ...
                                                    <form id="deleteForm{{ $item->id }}"
                                                        action="{{ route('administrator.social.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
