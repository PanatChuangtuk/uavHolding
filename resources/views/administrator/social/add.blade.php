...
@section('content')
    ...
    <form id="form-create" action="{{ route('administrator.social.submit') }}" method="POST" enctype="multipart/form-data"
        class="container">
        @csrf
        <div class="row justify-content-end mb-4">
            <div class="col-auto">
                <button type="submit" class="btn btn-success">Save</button>
                <a href="{{ route('administrator.social.submit') }}" class="btn btn-danger">Cancel</a>
            </div>
        </div>
        <div class="card p-4">
            <div class="mb-4 row">
            ...
            <div class="mb-4 row">
                ...
                <div class="col-md-10 ">
                    <textarea class="form-control" id="html" name="html" placeholder="Enter URL"></textarea>
                </div>
            </div>
            <style>
