            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.about') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.about.add') }}"
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            ...
                            <tbody class="table-border-bottom-0" id="aboutTableBody">
                                @foreach ($about as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->icon)
                                                <img src="{{ asset('upload/file/about/' . $item->icon) }}"
                                                    alt="{{ $item->icon }}" class="img-thumbnail w-px-50 h-px-50" />
                                            @else
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0"
                                                        href="{{ route('administrator.about.edit', ['id' => $item->id]) }}"
                                                    ...
                                                    <form id="deleteForm{{ $item->id }}"
                                                        action="{{ route('administrator.about.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
