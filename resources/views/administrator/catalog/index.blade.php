            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.catalog') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.catalog.add') }}"
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            ...
                            <tbody class="table-border-bottom-0" id="catalogTableBody">
                                @foreach ($catalog as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->image)
                                                <img src="{{ asset('upload/file/catalog/image/' . $item->image) }}"
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->content->file ?? 'No file' }}</td>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0"
                                                        href="{{ route('administrator.catalog.edit', ['id' => $item->id]) }}"
                                                    ...
                                                    <form id="deleteForm{{ $item->id }}"
                                                        action="{{ route('administrator.catalog.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
