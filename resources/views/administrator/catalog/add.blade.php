...
@section('content')
    ...
    <form id="form-create" action="{{ route('administrator.catalog.submit') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="tab-content">
                        @foreach ($language as $index => $languages)
                            <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                ...
                                <div class="mb-4 row">
                                    <label for="html5-url-input" class="col-md-2 col-form-label">File
                                        Upload({{ $languages->code }})</label>
                                    <input id="file-{{ $languages->id }}" name="file[{{ $languages->id }}]" type="file"
                        ...
                        <div class="tab-pane fade" id="tab-settings" role="tabpanel">
                            <div class="container mt-2">
                                <label for="html5-url-input" class="col-md-2 col-form-label">Upload Image</label>
