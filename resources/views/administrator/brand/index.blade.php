            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <form action="{{ route('administrator.brand') }}" method="GET"
                            ...
                            <div class="d-flex align-items-center ms-2">
                                <x-status-filter />
                                <a href="{{ route('administrator.brand.add') }}"
                            ...
                            <tbody class="table-border-bottom-0" id="brandTableBody">
                                @foreach ($brand as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->image)
                                                <img src="{{ asset('upload/file/brand/' . $item->image) }}"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="d-inline-block text-nowrap">
                                                    <a class="btn btn-icon btn-outline-primary border-0"
                                                        href="{{ route('administrator.brand.edit', ['id' => $item->id]) }}"
                                                    ...
                                                    <form id="deleteForm{{ $item->id }}"
                                                        action="{{ route('administrator.brand.destroy', ['id' => $item->id, 'page' => request()->get('page')]) }}"
