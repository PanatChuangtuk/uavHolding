...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<em class="icon ni ni-trash"></em>',
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<em class="icon ni ni-upload"></em>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<em class="icon ni ni-repeat-v"></em>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<em class="icon ni ni-download"></em>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<em class="icon ni ni-zoom-in"></em>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'View Details',
                    dragIcon: '<em class="icon ni ni-move"></em>',
                    dragClass: 'text-info',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<em class="icon ni ni-back-alt"></em>',
            next: '<em class="icon ni ni-forward-alt"></em>',
            toggleheader: '<em class="icon ni ni-swap-v"></em>',
            fullscreen: '<em class="icon ni ni-expand"></em>',
            borderless: '<em class="icon ni ni-maximize-alt"></em>',
